...
### [#](#只抓取-http-get-和-post-流量) 只抓取 HTTP GET 和 POST 流量
...
### [#](#提取-http-请求的-url) 提取 HTTP 请求的 URL
...
### [#](#提取-http-post-请求中的密码) 提取 HTTP POST 请求中的密码
...
### [#](#抓取非-echo-reply-类型的-icmp-数据包) 抓取非 ECHO/REPLY 类型的 ICMP 数据包
...
### [#](#抓取-smtp-pop3-协议的邮件) 抓取 SMTP/POP3 协议的邮件
...
### [#](#抓取-ntp-服务的查询和响应) 抓取 NTP 服务的查询和响应
...
### [#](#抓取-snmp-服务的查询和响应) 抓取 SNMP 服务的查询和响应
...
### [#](#过滤-nmap-nse-脚本测试结果) 过滤 Nmap NSE 脚本测试结果
...
### [#](#将输出内容重定向到-wireshark) 将输出内容重定向到 Wireshark
...
![img](工具 网络抓包神器 tcpdump 使用详解.assets/dev-network-tcpdump-1.png)

`-c` 选项用来限制抓取数据的大小。如果不限制大小，就只能通过 ctrl-c 来停止抓取，这样一来不仅关闭了 tcpdump，也关闭了 wireshark。

### [#](#找出发包最多的-ip) 找出发包最多的 IP
...
原文主要翻译自 《[Tcpdump Examples在新窗口打开](https://hackertarget.com/tcpdump-examples/)》。